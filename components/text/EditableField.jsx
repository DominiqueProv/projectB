...
const EditableField = (props) => {
  ...
  const { saveNote, formData, updateFormData } =
    useFiles();
    ...
    <div className='pr-3 lg:pr-16'>
      {isEditing ? (
        ...
        <div className='flex gap-3 group'>
          <span className={`py-2 ${!text.includes("Add") ? 'text-black' : 'text-black/15'} text-2xl lg:text-3xl font-semibold`} onClick={handleEditClick}>{text || 'Add a title'}</span>
          <ButtonNoteStyle
            handleClick={handleButtonClick}
