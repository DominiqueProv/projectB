...
const FileModal = ({ file }) => {
  ...
  return (
    <>
      ...
      >
        <Icon icon={"expand"} xClass={"text-indigo-800"} size={20} />
      </ButtonSecondary>
      <Modal>
        {showModal && (
          <>
            ...
            <div className="flex justify-center items-center absolute z-40 inset-0">
              <div className="flex h-full max-h-[80vh] sm:max-w-[80vw] rounded-lg p-3 relative flex-col bg-white">
                <button
                ...
                <div className="flex w-full h-full gap-2">
                  <div className="relative rounded-md overflow-hidden min-w-[300px]">
